...
void oled_show_once(void)
{
  ...
  if(Flag_Way==0)         OLED_ShowString(42,30," APP ");//APP模式
  else if(Flag_Way==1)    OLED_ShowString(42,30," PS2 ");//PS2模式
  else if(Flag_Way==2)    OLED_ShowString(42,30," CCD ");//CCD模式
  else if(Flag_Way==3)    OLED_ShowString(42,30," ELE ");//电磁巡线模式
  else if(Flag_Way==4)    OLED_ShowString(42,30,"=QJ4=");//自然前进模式 per 8 pos
  else if(Flag_Way==5)    OLED_ShowString(42,30,">PAR<");//
